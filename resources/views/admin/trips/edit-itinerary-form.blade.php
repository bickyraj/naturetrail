      ...
      <div class="kt-timeline-v2__items  kt-padding-top-25 kt-padding-bottom-30">
          <div class="kt-timeline-v2__item">
              ...
              <div class="kt-timeline-v2__item-text kt-timeline-v2__item-text--bold">
                ...
                <input type="text" name="trip_itineraries[][place_name]" id="input-trip-place-name" value="{{ $itinerary->place_name }}" class="form-control mb-3 form-control-sm" placeholder="Place Name">
                {{-- accomodation --}}
