                  ...
                  <div class="kt-portlet__body">
                    {{-- home page block --}}
                      <div class="tab-pane" data-index="2" id="kt_tabs_1_2" role="tabpanel">
                        <form class="kt-form" method="POST" action="{{ route('admin.why-book-with-us.store') }}" id="setting-home-form" enctype="multipart/form-data">
                          {{ csrf_field() }}
                          <div class="form-group row">
                            <label class="col-lg-2 col-form-label">Content</label>
                            <div class="col-lg-7">
                              <input type="hidden" name="whyBookWithUs">
                              <div id="summernote-home-content" class="summernote"><?= Setting::get('whyBookWithUs')??'' ?></div>
                            </div>
                          </div>
                          <hr>
...
$(function() {
  ...
  if (success_message) {
    ...
    $('#setting-home-form button[type="submit"]').on('click', function(event) {
      ...
      $('input[name="whyBookWithUs"]').val($('#summernote-home-content').summernote('code'));
