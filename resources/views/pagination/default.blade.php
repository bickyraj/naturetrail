    ...
    <nav>
        <ul class="flex items-center justify-center gap-2">
            ...
            @if ($paginator->onFirstPage())
                <li class="p-2 disabled text-light-gray" aria-disabled="true" aria-label="@lang('pagination.previous')">
            ...
            @else
                <li class="p-2 disabled text-light-gray" aria-disabled="true" aria-label="@lang('pagination.next')">
