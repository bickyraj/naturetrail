                ...
                <div class="grid gap-4 lg:grid-cols-2">
                    <div class="lg:pr-10 prose">
                        <h2>
                            ...
                            <div class="text-gray-600 text-3xl font-display font-bold uppercase lg:text-5xl">
                    ...
                    @if (!empty($destination->tour_guide_image_name))
                        <div class="lg:absolute w-full lg:w-1/2 right-0"><img src="{{ $destination->tour_guide_image_url }}"
                                style="padding-top: 44px;"></div>
                    @else
                        <div class="lg:absolute w-full lg:w-1/2 right-0"><img
                                src="{{ asset('assets/front/img/nepal.webp') }}" style="padding-top: 44px;"></div>
                    @endif
                </div>
            </div>
        </div>{{-- Travel Guide --}}
